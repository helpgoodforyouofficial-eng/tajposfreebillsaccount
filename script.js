...
(function(){
    ...
    if (contactDiv && !contactDiv.innerHTML.includes('contenteditable')) {
        contactDiv.innerHTML = 'Mobile: <div class="editable-text-container"><div contenteditable="true" style="display:inline-block; font-weight: normal; outline:none; min-width:100px; word-break:break-word; vertical-align:middle;">0334-6800959</div></div>';
    }
